...
[Version 0.12.0 for Drupal 8.x and 9.x deprecations](https://github.com/palantirnet/drupal-rector/tree/0.12.0). Note that Drupal 9 deprecation testing recommends PHP 8.
