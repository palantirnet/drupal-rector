...
[Version 0.12.3 for Drupal 8.x and 9.x deprecations](https://github.com/palantirnet/drupal-rector/tree/0.12.3). Note that Drupal 9 deprecation testing recommends PHP 8.

The 0.12.3 release bypasses a known conflict with Rector 0.12.18.
