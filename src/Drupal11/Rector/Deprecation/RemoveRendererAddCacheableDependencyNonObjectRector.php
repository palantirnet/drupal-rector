 ...
 */
class RemoveRendererAddCacheableDependencyNonObjectRector extends AbstractRector implements ComposerPackageConstraintInterface, DocumentedRuleInterface
{
