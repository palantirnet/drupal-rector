...
return static function (RectorConfig $rectorConfig): void {
    DeprecationBase::addClass(PhpUnitTestAnnotationToAttributeRector::class, $rectorConfig, false, [
        new PhpUnitTestAnnotationToAttributeConfiguration('11.0.0', '10.0.0', 'group', 'PHPUnit\Framework\Attributes\Group'),
        new PhpUnitTestAnnotationToAttributeConfiguration('11.0.0', '10.0.0', 'dataProvider', 'PHPUnit\Framework\Attributes\DataProvider'),
    ]);
};
