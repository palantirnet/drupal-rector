...
namespace DrupalRector\Tests\Drupal11\Rector\Deprecation\ViewsPluginHandlerManagerRector;

use DrupalRector\Services\DrupalRectorSettings;
use Rector\Testing\PHPUnit\AbstractRectorTestCase;

class ViewsPluginHandlerManagerRectorTest extends AbstractRectorTestCase
{
