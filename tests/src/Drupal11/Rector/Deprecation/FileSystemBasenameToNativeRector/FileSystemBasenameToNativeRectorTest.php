...
namespace DrupalRector\Tests\Drupal11\Rector\Deprecation\FileSystemBasenameToNativeRector;

use DrupalRector\Services\DrupalRectorSettings;
use Rector\Testing\PHPUnit\AbstractRectorTestCase;

class FileSystemBasenameToNativeRectorTest extends AbstractRectorTestCase
{
