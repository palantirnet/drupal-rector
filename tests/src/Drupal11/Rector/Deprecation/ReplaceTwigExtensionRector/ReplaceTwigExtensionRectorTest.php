...
namespace DrupalRector\Tests\Drupal11\Rector\Deprecation\ReplaceTwigExtensionRector;

use DrupalRector\Services\DrupalRectorSettings;
use Rector\Testing\PHPUnit\AbstractRectorTestCase;

class ReplaceTwigExtensionRectorTest extends AbstractRectorTestCase
{
