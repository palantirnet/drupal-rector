...
namespace DrupalRector\Tests\Drupal11\Rector\Deprecation\ErrorCurrentErrorHandlerRector;

use DrupalRector\Rector\AbstractDrupalCoreRector;
use Rector\Testing\PHPUnit\AbstractRectorTestCase;

class ErrorCurrentErrorHandlerRectorTest extends AbstractRectorTestCase
{
