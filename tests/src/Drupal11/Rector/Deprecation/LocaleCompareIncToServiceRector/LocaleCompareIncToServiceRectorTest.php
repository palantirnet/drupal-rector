...
namespace DrupalRector\Tests\Drupal11\Rector\Deprecation\LocaleCompareIncToServiceRector;

use DrupalRector\Services\DrupalRectorSettings;
use Rector\Testing\PHPUnit\AbstractRectorTestCase;

class LocaleCompareIncToServiceRectorTest extends AbstractRectorTestCase
{
