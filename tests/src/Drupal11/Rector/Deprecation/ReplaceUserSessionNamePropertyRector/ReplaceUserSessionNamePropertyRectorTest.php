...
namespace DrupalRector\Tests\Drupal11\Rector\Deprecation\ReplaceUserSessionNamePropertyRector;

use DrupalRector\Services\DrupalRectorSettings;
use Rector\Testing\PHPUnit\AbstractRectorTestCase;

class ReplaceUserSessionNamePropertyRectorTest extends AbstractRectorTestCase
{
