...
namespace DrupalRector\Tests\Drupal11\Rector\Deprecation\GetOriginalClassToGetDecoratedClassesRector;

use DrupalRector\Services\DrupalRectorSettings;
use Rector\Testing\PHPUnit\AbstractRectorTestCase;

class GetOriginalClassToGetDecoratedClassesRectorTest extends AbstractRectorTestCase
{
