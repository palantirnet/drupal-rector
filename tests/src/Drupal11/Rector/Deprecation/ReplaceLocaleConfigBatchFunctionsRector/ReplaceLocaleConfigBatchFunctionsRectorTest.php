...
namespace DrupalRector\Tests\Drupal11\Rector\Deprecation\ReplaceLocaleConfigBatchFunctionsRector;

use DrupalRector\Rector\AbstractDrupalCoreRector;
use Rector\Testing\PHPUnit\AbstractRectorTestCase;

class ReplaceLocaleConfigBatchFunctionsRectorTest extends AbstractRectorTestCase
{
