...
namespace DrupalRector\Tests\Drupal11\Rector\Deprecation\UseEntityTypeHasIntegerIdRector;

use DrupalRector\Services\DrupalRectorSettings;
use Rector\Testing\PHPUnit\AbstractRectorTestCase;

class UseEntityTypeHasIntegerIdRectorTest extends AbstractRectorTestCase
{
