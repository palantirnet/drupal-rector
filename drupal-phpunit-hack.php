 ...
 *
 * This ensures we can run our PHPUnit tests against 8.9 and 9, and more. This
 * files was copied from phpstan-drupal, where it was first created to support
 * the compatibility when performing static analysis.
 *
...
$filename = __DIR__ . '/tests/fixtures/MutatedTestCase.php';
